...
def country_maps(df_final):
    ...
    for index, info in base_graph_map.iterrows():
        folium.Marker([info['Delivery_location_latitude'], info['Delivery_location_longitude']],
                     popup=info[['City', 'Road_traffic_density']]).add_to(mapa)    #TODO: Essa função traz regiões por médias de latitude x longitude e o pop-up mostra as mesmas
    ...
    return folium_static(mapa, width= 1024,height=600)
